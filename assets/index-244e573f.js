 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ak{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(lk(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function lk(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const bh="@firebase/app",Jm="0.9.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vh="[DEFAULT]",Lk={[bh]:"fire-core",[uk]:"fire-core-compat",[hk]:"fire-analytics",[ck]:"fire-analytics-compat",[fk]:"fire-app-check",[dk]:"fire-app-check-compat",[pk]:"fire-auth",[mk]:"fire-auth-compat",[gk]:"fire-rtdb",[yk]:"fire-rtdb-compat",[vk]:"fire-fn",[wk]:"fire-fn-compat",[Ek]:"fire-iid",[_k]:"fire-iid-compat",[Sk]:"fire-fcm",[Tk]:"fire-fcm-compat",[Ik]:"fire-perf",[kk]:"fire-perf-compat",[Ck]:"fire-rc",[Nk]:"fire-rc-compat",[Rk]:"fire-gcs",[Ak]:"fire-gcs-compat",[Pk]:"fire-fst",[xk]:"fire-fst-compat","fire-js":"fire-js",[Dk]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi=Ok;function W0(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Vh,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Gn.create("bad-app-name",{appName:String(i)});if(n||(n=z0()),!n)throw Gn.create("no-options");const s=wl.get(i);if(s){if(vl(n,s.options)&&vl(r,s.config))return s;throw Gn.create("duplicate-app",{appName:i})}const o=new WI(i);for(const l of zh.values())o.addComponent(l);const a=new Uk(n,r,o);return wl.set(i,a),a}function K0(t=Vh){const e=wl.get(t);if(!e&&t===Vh&&z0())return W0();if(!e)throw Gn.create("no-app",{appName:t});return e}function Qn(t,e,n){var r;let i=(r=Lk[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Lr.warn(a.join(" "));return}xi(new Or(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mx(t,e,n){var r;const i=ar(t),s={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};if(!((r=i._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const o=await Oi(i,s,"getOobCode",!0);n&&Tc(i,o,n),await _c(i,o)}else n&&Tc(i,s,n),await _c(i,s).catch(async o=>{if(o.code==="auth/missing-recaptcha-token"){console.log("Password resets are protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the password reset flow.");const a=await Oi(i,s,"getOobCode",!0);n&&Tc(i,a,n),await _c(i,a)}else return Promise.reject(o)})}async function Ux(t,e,n){var r;const i=ar(t),s={returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"};let o;if(!((r=i._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const u=await Oi(i,s,"signUpPassword");o=Sc(i,u)}else o=Sc(i,s).catch(async u=>{if(u.code==="auth/missing-recaptcha-token"){console.log("Sign-up is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-up flow.");const c=await Oi(i,s,"signUpPassword");return Sc(i,c)}else return Promise.reject(u)});const a=await o.catch(u=>Promise.reject(u)),l=await Mr._fromIdTokenResponse(i,"signIn",a);return await i._updateCurrentUser(l.user),l}function Fx(t,e,n){return MC(Je(t),Qi.credential(e,n))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(t="Unexpected state"){const e=`FIRESTORE (${Ji}) INTERNAL ASSERTION FAILED: `+t;throw yn(e),new Error(e)}function ie(t,e){t||F()}function j(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZA{constructor(e,n,r,i,s){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.Eu=[],this.Au=new Map,this.vu=new Set,this.Ru=[],this.Pu=s,this.Pu.Yr(o=>{r.enqueueAndForget(async()=>{Gr(this)&&(D("RemoteStore","Restarting streams for network reachability change."),await async function(a){const l=j(a);l.vu.add(4),await Wo(l),l.bu.set("Unknown"),l.vu.delete(4),await xu(l)}(this))})}),this.bu=new JA(r,i)}}async function xu(t){if(Gr(t))for(const e of t.Ru)await e(!0)}async function Wo(t){for(const e of t.Ru)await e(!1)}function yE(t,e){const n=j(t);n.Au.has(e.targetId)||(n.Au.set(e.targetId,e),vp(n)?yp(n):es(n).Ko()&&gp(n,e))}function vE(t,e){const n=j(t),r=es(n);n.Au.delete(e),r.Ko()&&wE(n,e),n.Au.size===0&&(r.Ko()?r.jo():Gr(n)&&n.bu.set("Unknown"))}function gp(t,e){if(t.Vu.qt(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(V.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}es(t).su(e)}function wE(t,e){t.Vu.qt(e),es(t).iu(e)}function yp(t){t.Vu=new nA({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),le:e=>t.Au.get(e)||null,ue:()=>t.datastore.serializer.databaseId}),es(t).start(),t.bu.gu()}function vp(t){return Gr(t)&&!es(t).Uo()&&t.Au.size>0}function Gr(t){return j(t).vu.size===0}function EE(t){t.Vu=void 0}async function eP(t){t.Au.forEach((e,n)=>{gp(t,e)})}async function tP(t,e){EE(t),vp(t)?(t.bu.Iu(e),yp(t)):t.bu.set("Unknown")}async function nP(t,e,n){if(t.bu.set("Online"),e instanceof oE&&e.state===2&&e.cause)try{await async function(r,i){const s=i.cause;for(const o of i.targetIds)r.Au.has(o)&&(await r.remoteSyncer.rejectListen(o,s),r.Au.delete(o),r.Vu.removeTarget(o))}(t,e)}catch(r){D("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await bl(t,r)}else if(e instanceof ja?t.Vu.Ht(e):e instanceof sE?t.Vu.ne(e):t.Vu.Xt(e),!n.isEqual(V.min()))try{const r=await pE(t.localStore);n.compareTo(r)>=0&&await function(i,s){const o=i.Vu.ce(s);return o.targetChanges.forEach((a,l)=>{if(a.resumeToken.approximateByteSize()>0){const u=i.Au.get(l);u&&i.Au.set(l,u.withResumeToken(a.resumeToken,s))}}),o.targetMismatches.forEach((a,l)=>{const u=i.Au.get(a);if(!u)return;i.Au.set(a,u.withResumeToken(Ze.EMPTY_BYTE_STRING,u.snapshotVersion)),wE(i,a);const c=new Mn(u.target,a,l,u.sequenceNumber);gp(i,c)}),i.remoteSyncer.applyRemoteEvent(o)}(t,n)}catch(r){D("RemoteStore","Failed to raise snapshot:",r),await bl(t,r)}}async function bl(t,e,n){if(!jo(e))throw e;t.vu.add(1),await Wo(t),t.bu.set("Offline"),n||(n=()=>pE(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{D("RemoteStore","Retrying IndexedDB access"),await n(),t.vu.delete(1),await xu(t)})}function _E(t,e){return e().catch(n=>bl(t,n,e))}async function Du(t){const e=j(t),n=tr(e);let r=e.Eu.length>0?e.Eu[e.Eu.length-1].batchId:-1;for(;rP(e);)try{const i=await zA(e.localStore,r);if(i===null){e.Eu.length===0&&n.jo();break}r=i.batchId,iP(e,i)}catch(i){await bl(e,i)}SE(e)&&TE(e)}function rP(t){return Gr(t)&&t.Eu.length<10}function iP(t,e){t.Eu.push(e);const n=tr(t);n.Ko()&&n.ou&&n.uu(e.mutations)}function SE(t){return Gr(t)&&!tr(t).Uo()&&t.Eu.length>0}function TE(t){tr(t).start()}async function sP(t){tr(t).hu()}async function oP(t){const e=tr(t);for(const n of t.Eu)e.uu(n.mutations)}async function aP(t,e,n){const r=t.Eu.shift(),i=up.from(r,e,n);await _E(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await Du(t)}async function lP(t,e){e&&tr(t).ou&&await async function(n,r){if(i=r.code,ZR(i)&&i!==T.ABORTED){const s=n.Eu.shift();tr(n).Qo(),await _E(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,r)),await Du(n)}var i}(t,e),SE(t)&&TE(t)}async function iy(t,e){const n=j(t);n.asyncQueue.verifyOperationInProgress(),D("RemoteStore","RemoteStore received new credentials");const r=Gr(n);n.vu.add(3),await Wo(n),r&&n.bu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.vu.delete(3),await xu(n)}async function uP(t,e){const n=j(t);e?(n.vu.delete(2),await xu(n)):e||(n.vu.add(2),await Wo(n),n.bu.set("Unknown"))}function es(t){return t.Su||(t.Su=function(e,n,r){const i=j(e);return i.fu(),new QA(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,r)}(t.datastore,t.asyncQueue,{uo:eP.bind(null,t),ao:tP.bind(null,t),nu:nP.bind(null,t)}),t.Ru.push(async e=>{e?(t.Su.Qo(),vp(t)?yp(t):t.bu.set("Unknown")):(await t.Su.stop(),EE(t))})),t.Su}function tr(t){return t.Du||(t.Du=function(e,n,r){const i=j(e);return i.fu(),new YA(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,r)}(t.datastore,t.asyncQueue,{uo:sP.bind(null,t),ao:lP.bind(null,t),au:oP.bind(null,t),cu:aP.bind(null,t)}),t.Ru.push(async e=>{e?(t.Du.Qo(),await Du(t)):(await t.Du.stop(),t.Eu.length>0&&(D("RemoteStore",`Stopping write stream with ${t.Eu.length} pending writes`),t.Eu=[]))})),t.Du}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rx{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class jE extends VE{constructor(e,n,r,i,s,o){super(e,n,r,i,o),this._firestore=e,this._firestoreImpl=e,this.metadata=s}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new ix(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const r=this._document.data.field(zE("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,n.serverTimestamps)}}}class ix extends jE{data(e={}){return super.data(e)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hx(t){t=Vr(t,vt);const e=Vr(t.firestore,Ou);return VP(DE(e),t._key).then(n=>ax(e,t,n))}class sx extends tx{constructor(e){super(),this.firestore=e}convertBytes(e){return new zi(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new vt(this.firestore,null,n)}}function Wx(t,e,n){t=Vr(t,vt);const r=Vr(t.firestore,Ou),i=nx(t.converter,e,n);return BE(r,[YP(ME(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,Yt.none())])}function ox(t,e,n,...r){t=Vr(t,vt);const i=Vr(t.firestore,Ou),s=ME(i);let o;return o=typeof(e=Je(e))=="string"||e instanceof Lu?JP(s,"updateDoc",t._key,e,n,r):XP(s,"updateDoc",t._key,e),BE(i,[o.toMutation(t._key,Yt.exists(!0))])}function BE(t,e){return function(n,r){const i=new Yn;return n.asyncQueue.enqueueAndForget(async()=>IP(await FP(n),r,i)),i.promise}(DE(t),e)}function ax(t,e,n){const r=n.docs.get(e._key),i=new sx(t);return new jE(t,i,e._key,r,new rx(n.hasPendingWrites,n.fromCache),e.converter)}function Kx(){return new Rp("serverTimestamp")}(function(t,e=!0){(function(n){Ji=n})(Gi),xi(new Or("firestore",(n,{instanceIdentifier:r,options:i})=>{const s=n.getProvider("app").getImmediate(),o=new Ou(new iR(n.getProvider("auth-internal")),new lR(n.getProvider("app-check-internal")),function(a,l){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new O(T.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new mo(a.options.projectId,l)}(s,r),s);return i=Object.assign({useFetchStreams:e},i),o._setSettings(i),o},"PUBLIC").setMultipleInstances(!0)),Qn(Lg,"3.12.0",t),Qn(Lg,"3.12.0","esm2017")})();var lx="firebase",ux="9.22.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
